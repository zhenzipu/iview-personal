            ...
            <div class="height-200px">
                <Row type="flex" justify="center" align="middle" class="height-100">
                    <div style="display: block;width: 100%;text-align: center;">
                        <Upload :name="name" :action="action" :format="format" :on-format-error="handleFormatError" :before-upload="handleBeforeUpload" :on-progress="handleProgress" :on-success="handleSuccess" :on-error="handleError">
                            <span>请选择文件&nbsp;&nbsp;</span>
